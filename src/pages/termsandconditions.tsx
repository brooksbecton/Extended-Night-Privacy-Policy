...
const Terms: React.FC<PageProps<DataProps>> = ({ data, path, location }) => {
  ...
  return (
    <Layout title={siteTitle} location={location}>
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Brooks
        Becton.
      </p>
      <p>
      ...
      <p>
        ...
        phone’s security features and it could mean that the Extended Night
        Companion App app won’t work properly or at all.
      </p>
      <div>
        <p>
      ...
      <p>
        You should be aware that there are certain things that Brooks Becton
        ...
        can be Wi-Fi, or provided by your mobile network provider, but Brooks
        Becton cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, Brooks Becton cannot always take responsibility
        ...
        avail the Service, Brooks Becton cannot accept responsibility.
      </p>
      <p>
        ...
        make it available to you. Brooks Becton accepts no liability for any
      ...
      <p>
        ...
        to keep using the app. Brooks Becton does not promise that it will
      ...
      <p>These terms and conditions are effective as of 2021-02-22</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Terms and Conditions,
        do not hesitate to contact me at dirtydogsoftware88@gmail.com.
      </p>
      <p>
