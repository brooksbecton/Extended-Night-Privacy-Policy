...
const Privacy: React.FC<PageProps<DataProps>> = ({ data, path, location }) => {
  ...
  return (
    <Layout title={siteTitle} location={location}>
      ...
      <p>
        Brooks Becton built the Extended Night Companion App app as an Ad
        Supported app. This SERVICE is provided by Brooks Becton at no cost and
      ...
      <p>This policy is effective as of 2021-02-22</p>
      <p>
